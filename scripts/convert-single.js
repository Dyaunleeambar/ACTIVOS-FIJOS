...
const { convertToPdf, processMarkdownContent } = require('./convert-docs');
...
function showHelp() {
    console.log(`
📄 Convertidor de Markdown a PDF - Archivo Individual

Uso: node scripts/convert-single.js <archivo.md> [opciones]
...
Ejemplos:
  node scripts/convert-single.js README.md
  node scripts/convert-single.js docs/01-analisis-requerimientos.md
